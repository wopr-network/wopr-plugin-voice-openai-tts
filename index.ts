...
const DEFAULT_CONFIG: Required<Omit<OpenAITTSConfig, "apiKey" | "instructions">> & {
  apiKey?: string;
  instructions?: string;
} = {
  apiKey: undefined,
...
const OPENAI_VOICES: Voice[] = [
  ...
  { id: "ash", name: "Ash", gender: "male", description: "Clear, professional" },
  { id: "ballad", name: "Ballad", gender: "female", description: "Warm, melodic" },
  { id: "coral", name: "Coral", gender: "female", description: "Natural, friendly" },
  { id: "echo", name: "Echo", gender: "male", description: "Deep, authoritative" },
  { id: "fable", name: "Fable", gender: "neutral", description: "Storytelling" },
  { id: "nova", name: "Nova", gender: "female", description: "Energetic, youthful" },
  { id: "onyx", name: "Onyx", gender: "male", description: "Deep, resonant" },
  { id: "sage", name: "Sage", gender: "neutral", description: "Calm, wise" },
  { id: "shimmer", name: "Shimmer", gender: "female", description: "Bright, cheerful" },
  { id: "verse", name: "Verse", gender: "neutral", description: "Expressive, dynamic" },
  { id: "marin", name: "Marin", gender: "female", description: "Best quality female" },
  { id: "cedar", name: "Cedar", gender: "male", description: "Best quality male" },
];
